...
{
    public partial class frmSawing : Form
    {
        ...
        /// <param name="e"></param>
        private void frmSawing_Load(object sender, EventArgs e)
        {
            WorkOrderService service = new WorkOrderService();
            list = service.GetWorkOrder("GJ003");
            if (list != null)
            {
                //작업장 콤보박스에 바인딩
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnWStop_Click_1(object sender, EventArgs e)
        {
            timer1.Stop();
            timer2.Start();
